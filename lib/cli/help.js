...
module.exports = function(yargs_, helpPage_) {
  ...
  header = terminalFeatures.color.has16m ? function() {
    ...
    return ["" + clr.red + hT[0][0] + clr.bright + hT[0][1], "" + images.space + clr.green + hT[1][0] + clr.bright + hT[1][1] + " " + clr.normal + (trucolor.getDescription()), "" + images.space + clr.blue + hT[2][0] + clr.bright + hT[2][1] + " " + clr.grey + (trucolor.getVersion(3))].join("\n");
  } : function() {
    return ["" + clr.bright + (trucolor.getName()) + clr.normal, "" + images.space + (trucolor.getDescription()), "" + images.space + clr.grey + (trucolor.getVersion(3)) + clr.normal].join("\n");
  };
          ...
          content: [
            {
              ...
              Command: clr.command + "trucolor" + clr.option + " --swatch " + clr.argument + "purple desat 70" + clr.normal,

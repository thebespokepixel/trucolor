...
/*
 trucolor (v0.1.4-alpha.1) 24bit color tools for the command line
...
Processor = (function() {
  ...
  Processor.prototype.setAttr = function(attr_) {
    if (attr_ === 'background' || attr_ === 'bold' || attr_ === 'faint' || attr_ === 'italic' || attr_ === 'invert' || attr_ === 'underline' || attr_ === 'blink') {
      this.haveAttrs = true;
  ...
  Processor.prototype.faint = function() {
    this.setAttr('faint');
    return console.debug("Special::faint");
  };

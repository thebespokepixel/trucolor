...
Output = (function() {
  function Output(rgbIn, attrs) {
    ...
    if (rgbIn != null) {
      if (/^[0-9a-f]{6}$/i.test(rgbIn)) {
        this.rgb = converter.hex.rgb(rgbIn);
        this.hex = rgbIn;
        ...
        this.rgb = rgbIn;
        this.hex = converter.rgb.hex(rgbIn);
      }
      this.red = this.rgb[0];
  ...
  Output.prototype.swatch = function() {
    ...
    if ((this.rgb != null) && (terminalFeatures.color.level != null)) {
      sgr.code = ['', converter.rgb.ansi16(this.rgb), converter.rgb.ansi256(this.rgb), this.rgb.join(';')][(ref2 = terminalFeatures.color.level) != null ? ref2 : 0];

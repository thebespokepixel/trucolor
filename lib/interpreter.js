...
Interpreter = (function() {
    ...
    this.RGB = (function() {
      switch (this.source.space) {
        ...
        case '#HEX':
          ...
          return converter.hex.rgb(this.name);
        case 'HEXHEX':
        case '#HEXHEX':
          this.name = this.source.input;
          return converter.hex.rgb(this.name);
        case 'RGB':
          this.name = converter.rgb.hex(this.source.input);
          return converter.hex.rgb(this.name);
        case 'HSL':
          this.name = converter.hsl.hex(this.source.input);
          return converter.hsl.rgb(this.source.input);
        case 'HSV':
          this.name = converter.hsv.hex(this.source.input);
          return converter.hsv.rgb(this.source.input);
        case 'HWB':
          this.name = converter.hwb.hex(this.source.input);
          return converter.hwb.rgb(this.source.input);
        case 'SGR':
          this.name = this.source.input;
          return this.source.input;
        case 'named':
          this.name = converter.keyword.hex(this.source.input);
          return converter.keyword.rgb(this.source.input);
      }
    }).call(this);
  ...
  Interpreter.prototype.toString = function() {
    return converter.rgb.hex(this.RGB);
  };
